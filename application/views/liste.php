                        ...
                        foreach ($liste_produits as $row) {
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <p><a href="<?= site_url("produits/modif/".$row->pro_id); ?>" title="">Modifier</a></p>
                                    <p><a href="<?= site_url("produits/suppr/". $row->pro_id) ?>" onclick="return confirm('Veuillez confirmer')">Supprimer</a></p>
                                </td>
                            </tr>
                        <?php
                        }
