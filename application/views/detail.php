...
<body>
	<div class="container">
		...
		<nav class="nav">
			...
			<!--<a class="navbar-brand" href="<?= site_url("produits/ajout/") ?>">AJOUT</a>
			<a class="navbar-brand" href="<?= site_url("produits/modif/" . $produit->pro_id); ?>">MODIFIER</a>
			<a class="navbar-brand" href="<?= site_url("produits/suppr/" . $produit->pro_id) ?>" onclick="return confirm('Veuillez confirmer')">SUPPRIMER</a>
            -->
